...
/*!---------------------------------------------------------------------------
 Define ADC intercept point and Voltage/Temparture linear function slope
 *----------------------------------------------------------------------------*/
#define ADC_REF_2V6       2.6
#define ADC_REF_3V3       3.3
#define ADC_RESOLUTION    4096 /* 2^12 - 12 bits ADC resolution */

#define ADC_AVG_COUNT 16

#define ADC_COUNT_RESOLUTION_MULTIPLIER (ADC_AVG_COUNT * ADC_RESOLUTION)

#define ADC_INTERCEPT     1.558576
#define ADC_SLOPE         0.003569

#define ADC_MULTIPLIER  (100000UL)
#define TEMP_MULTIPLIER (10UL)
#define TEMP_MULTIPLIER_SHELL (ADC_MULTIPLIER * TEMP_MULTIPLIER)
 ...
 * Global integer where the y-intercept of the temperature curve is stored.
 */
void SystemTemperatureByADCValue(uint32_t ulADCValue, int* ulTempValue, int nDecimal);
